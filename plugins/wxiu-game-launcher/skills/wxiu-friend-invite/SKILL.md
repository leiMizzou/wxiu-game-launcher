...
description: Help the user start a wxiu.com game for friends, obtain the site's shareable invitation link, and draft a concise invite message without sending it. Use when the user asks to play with friends, open a co-op game, create a room or invite, 发给朋友, 好友开黑, 双人游戏, 联机, 邀请链接, or 开房.
---
