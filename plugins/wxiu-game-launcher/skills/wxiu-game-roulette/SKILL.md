...
description: Pick a wxiu.com arcade game from live lobby choices using mood, available time, party size, genre, activity, and exclusions. Use when the user asks what to play, wants a surprise or reroll, says 转一下轮盘, 游戏轮盘, 随便挑一个, 我只有十分钟, 想轻松玩, 不要格斗, or wants Codex to choose and open one game.
---
