...
description: Generate a playful, time-boxed arcade break challenge for games available on wxiu.com, optionally using the live lobby and opening the chosen game. Use when the user asks for a random game, daily challenge, arcade challenge, challenge mode, 随机一个, 今日挑战, 街机挑战, 休息一下, or 不知道玩什么.
---
