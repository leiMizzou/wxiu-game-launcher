...
description: Open the wxiu.com portal or a requested arcade room as a deliberate Vibe Coding break in Codex's built-in Browser. Use when the user asks to open, launch, visit, reload, or play wxiu, 微秀游戏, 微秀游戏大厅, 街机休息, wxiu.com, or a named game such as 拳皇, 合金弹头, 恐龙快打, 三国战纪, 侍魂, 街霸, or 圆桌武士.
---
...
When this is part of a coding session, keep the break time-boxed and make it easy to return to the repository.
